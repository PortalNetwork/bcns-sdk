...
var _DataWrite = require("./DataWrite");

var _DataWrite2 = _interopRequireDefault(_DataWrite);
...
var BCNS = function (_BITBOXCli) {
  _inherits(BCNS, _BITBOXCli);

  function BCNS(config) {
    _classCallCheck(this, BCNS);

    var _this = _possibleConstructorReturn(this, (BCNS.__proto__ || Object.getPrototypeOf(BCNS)).call(this, config));

    if (config && config.restURL && config.restURL !== "") {
      _this.restURL = config.restURL;
    } else {
      _this.restURL = "https://bcns-api.portal.network/v1/";
    }

    _this.DataWrite = new _DataWrite2.default(_this.restURL);
